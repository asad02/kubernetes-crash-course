<!---
Current Directory : /asad02/git/kubernetes-crash-course/11-istio-scripts-and-configuration
-->
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - image: asad02/hello-world-rest-api:0.0.1-RELEASE
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: hello-world-rest-api
          image: asad02/hello-world-rest-api:0.0.2-RELEASE
          imagePullPolicy: IfNotPresent #Always
          ports:
            - containerPort: 8080
```
